...
export class MedicalRecord {
  ...
  @Prop({ type: [{ name: String, severity: String, reaction: String, treatment: String, _id: false }], default: [] })
  allergies: any[];

  @Prop({ type: [{ name: String, severity: String, managementPlan: String, emergencyProtocol: String, _id: false }], default: [] })
  conditions: any[];

  @Prop({ type: [{ name: String, dosage: String, frequency: String, keptAt: String, isActive: Boolean, _id: false }], default: [] })
  medications: any[];
